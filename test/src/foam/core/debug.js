...
function makeBodyCommentTestFn() { // multiline parsing, ha
  return function(str, bool) {
    /**
      A method
      @param {foam.Boolean} bool Is a nice boolean
      @arg {foam.String} str Is a nice string
      @arg {foam.Number} another Additional arg
      @return {foam.Boolean} Returns true
    */
    return ( true );
  };
}
...
function makeInvalidBodyCommentTestFn() { // multiline parsing, ha
  return function(/*foam.Number*/str, bool) {
    /**
      A method
      @arg {foam.String} str Dupe arg
    */
    return ( true );
  };
}
function makeInvalidReturnBodyCommentTestFn() { // multiline parsing, ha
  return function(str, bool /*foam.Number*/) {
    /**
      A method
      @return {foam.String} Dupe return
    */
    return ( true );
  };
}
...
describe('foam.Function.typeCheck', function() {
  ...
  it('fails bad return type', function() {
    var rfn = foam.Function.typeCheck(function(arg /* foam.Object */) {
      return arg;
    });
  ...
  it('allows repeated args', function() {
    var rfn = foam.Function
      .typeCheck(function(/* ...foam.Number */ num) { return 1; });
    expect(function() { rfn(); }).not.toThrow();
  ...
  it('allows repeated ES2016 ...rest arguments', function() {
    ...
    restFn.toString = function() {
      return 'function(arg1, /*foam.Number*/ ...num) { return 1; }';
    };
  ...
  it('accepts explicit arguments list', function() {
    var args = [ foam.core.Argument.create({
      name: 'str',
      typeName: 'foam.String',
      index: 0
    }) ];

    var rfn = foam.Function
      .typeCheck(function(/* foam.Number */ num) { return 1; }, args);
...
describe('Method type checking', function() {
  ...
  it('ignores undefined methods', function() {
    ...
    expect(capture()[0].startsWith('Method: Failed')).toBe(true);
  });
